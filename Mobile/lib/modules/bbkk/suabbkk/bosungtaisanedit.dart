...
class BoSungTaiSanEditPage extends StatefulWidget {
  const BoSungTaiSanEditPage({Key? key}) : super(key: key);

  @override
  _BoSungTaiSanEditPageState createState() => _BoSungTaiSanEditPageState();
}

class _BoSungTaiSanEditPageState extends State<BoSungTaiSanEditPage> {
