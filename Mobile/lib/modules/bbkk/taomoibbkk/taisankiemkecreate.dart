...
import 'package:qltstc_kiemke/modules/bbkk/taomoibbkk/bosungtaisancreate.dart';
...
class TaiSanKiemKeCreatePage extends StatefulWidget {
  TaiSanKiemKeCreatePage({required this.ngayKiemKe});

  final String? ngayKiemKe;

  @override
  _TaiSanKiemKeCreatePageState createState() => _TaiSanKiemKeCreatePageState();
}

class _TaiSanKiemKeCreatePageState extends State<TaiSanKiemKeCreatePage> {
  ...
  Future<void> _handleSave(bool isFinalSave) async {
    ...
    syncTaiSan();
    final result =
        await BBKKService.sharedInstance().createBBKK(isNhap: isFinalSave);
    loadingQueue.remove("saving");
