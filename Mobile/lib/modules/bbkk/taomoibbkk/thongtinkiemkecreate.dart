...
import 'package:qltstc_kiemke/modules/bbkk/taomoibbkk/hoidongkiemkecreate.dart';
...
class ThongTinKiemKeCreatePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ThongTinKiemKeCreatePage();
  }
}

class _ThongTinKiemKeCreatePage extends State<ThongTinKiemKeCreatePage> {
  ...
  void onSaveDraft(context) async {
    ...
    var result = await BBKKService.sharedInstance().createBBKK(isNhap: false);
    if (result) {
  ...
  void onContinue(context) async {
    ...
    Get.to(() => HoiDongKiemKeCreatePage());
  }
