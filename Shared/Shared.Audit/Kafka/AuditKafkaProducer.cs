...
public interface IAuditKafkaProducer
{
    Task PublishAsync<T>(string key, T message, CancellationToken cancellationToken = default) where T : class;
}

public class AuditKafkaProducer : IAuditKafkaProducer, IDisposable
{
    private readonly IProducer<string, string> _producer;
    private readonly KafkaOptions _options;
    public AuditKafkaProducer(IOptions<KafkaOptions> options)
    {
    ...
    {
        string topicName = _options.Topics.AuditLog;
